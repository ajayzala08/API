...
namespace ATSAPI.Controllers
{
    ...
    public class TeamLead_MasterController : ApiController
    {
        
        public ResponseModel GetTeamLead_Master()
        {
            ...
            try
            {
                ...
                {
                    List<UserModel> userModels = db.User_Master.Where(x => x.E_Role == "Teamlead" && x.E_Is_Active == 1 && x.E_Is_Delete == 0).Select(x => new UserModel
                    {
                        EId = x.E_Id,
                        ECode = x.E_Code,
