...
namespace ATSAPI.Controllers
{
    ...
    public class MonthOfferController : ApiController
    {
        public ResponseModel GetMonthOffer()
        {
            ...
            try
            {
                ...
                {
                    int month = 5; //System.DateTime.Now.Month;
                    int year = 2019; //System.DateTime.Now.Year;
                    List<MonthModel> offerlist = (from c in db.Offer_Master
                                     where c.O_Off_Date.Value.Month ==month  && c.O_Off_Date.Value.Year == year
                                     join
